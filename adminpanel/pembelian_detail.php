...
$id = $_GET['p'];
$query = mysqli_query($conn, "SELECT * FROM pembelian_prdk where kode_beli = '$id' ");
    ...
    <div class="container mt-5">
        ...
        <div class="my-5 col-12 col-md-5" id="ConsutaBPM">
            ...
            <form action="" method="post" enctype="multipart/form-data" class="mt-5">
                <div>
                    <label for="nama">Kode Beli : </label>
                    <label for="nama">
                        <?php echo $data['kode_beli']; ?>
                    </label>
                </div>
                <div>
                ...
                <div>
                    ...
                    <label for="nama">
                        <?php echo $data['current_time']; ?>
                    </label>
                </div>
                <div>
                    <label for="nama">Gambar Barang: </label>
