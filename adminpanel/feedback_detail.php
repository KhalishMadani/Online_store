...
$id = $_GET['p'];
$query = mysqli_query($conn, "SELECT * FROM feedback where kode_beli='$id'");
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="my-5 col-12 col-md-5" id="ConsutaBPM">
            <h3>Feedback Kode Pesanan: <?php echo $data['kode_beli']; ?></h3>
            ...
            <form action="" method="post" enctype="multipart/form-data" class="mt-5">
                ...
                <div>
                    <label for="nama">Tanggal Ulasan : </label>
                    <label for="nama">
